    ...
    const options = useMemo(() => {
        return {
            ...
            modes: {
                ...
                push: { default: true, groups: [], quantity: 7, },
                remove: { quantity: 2, },
            ...
            particles: {
                bounce: { horizontal: { random: { enable: true, minimumValue: 0.1, }, value: 1, }, vertical: { random: { enable: true, minimumValue: 0.1, }, value: 1, }},
                collisions: { absorb: { speed: 2, }, bounce: { horizontal: { random: { enable: false, minimumValue: 0.1, }, value: 1, }, vertical: { random: { enable: false, minimumValue: 0.1, }, value: 1, }}, enable: false, outMode: { default: "bounce" }, overlap: { enable: true, retries: 0, }},
                color: { value: "#000000", animation: { h: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }, s: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }, l: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }} },
                move: { angle: { offset: 0, value: 90, }, attract: { distance: 200, enable: false, rotate: { x: 600, y: 1200, }}, center: { x: 50, y: 50, mode: "percent", radius: 0, }, decay: 0, distance: {}, direction: "none", drift: 0, enable: true, gravity: { acceleration: 9.81, enable: false, inverse: false, maxSpeed: 50, }, path: { clamp: true, delay: { random: { enable: false, minimumValue: 0, }, value: 0, }, enable: false, options: {}, }, outModes: { default: "out", bottom: "out", left: "out", right: "out", top: "out", }, random: false, size: false, speed: 2, spin: { acceleration: 0, enable: false, }, straight: false, trail: { enable: false, length: 10, fill: {}, }, vibrate: false, warp: false, }, number: { density: { enable: true, width: 1920, height: 1080, }, limit: 0, value: 20, }, opacity: { random: { enable: true, minimumValue: 0.1, }, value: { min: 0.1, max: 1, }, animation: { count: 0, enable: true, speed: 1, decay: 0, sync: false, destroy: "none", startValue: "random", minimumValue: 0.2, }}, reduceDuplicates: false, shadow: { blur: 0, color: { value: "#000" }, enable: false, offset: { x: 0, y: 0, }},
                shape: { options: { character: { fill: false, font: "Verdana", style: "", value: "*", weight: "400", }, char: { fill: false, font: "Verdana", style: "", value: "*", weight: "400", }, polygon: { sides: 5, }, star: { sides: 5, }, image: [ { src: "https://avatars.githubusercontent.com/u/77453675?s=200&v=4", width: 32, height: 32, }, ], images: [ { src: "https://avatars.githubusercontent.com/u/77453675?s=200&v=4", width: 32, height: 32, }, ] }, type: "image", },
                size: { random: { enable: true, minimumValue: 16 }, value: 32, animation: { count: 0, enable: true, speed: 40, decay: 0, sync: false, destroy: "none", startValue: "random", minimumValue: 0.1, }},
                stroke: { width: 0, color: { value: "#000000", animation: { h: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }, s: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }, l: { count: 0, enable: false, offset: 0, speed: 1, decay: 0, sync: true, }}}},
                ...
                rotate: { random: { enable: true, minimumValue: 0, }, value: 0, animation: { enable: true, speed: 10, decay: 0, sync: false, }, direction: "random", path: false, },
                destroy: { bounds: {}, mode: "none", split: { count: 1, factor: { random: { enable: false, minimumValue: 0, }, value: 3, }, rate: { random: { enable: false, minimumValue: 0, }, value: { min: 4, max: 9, }}, sizeOffset: true, particles: {}, }},
                ...
                twinkle: { lines: { enable: true, frequency: 0.05, opacity: 1, }, particles: { enable: true, frequency: 0.05, opacity: 1, }},
                wobble: { distance: 5, enable: true, speed: { angle: 50, move: 10, }},
                orbit: { animation: { count: 0, enable: true, speed: 25, decay: 0, sync: false, }, enable: true, opacity: 1, rotation: { random: { enable: false, minimumValue: 0, }, value: 45, }, width: 1, },
